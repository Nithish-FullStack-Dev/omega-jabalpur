...
export default function HomeHero() {
  ...
  const mobileDoctorRef = useRef<HTMLDivElement>(null);

  useLayoutEffect(() => {
    if (!doctorRef.current || !mobileDoctorRef.current) return;

    const ctx = gsap.context(() => {
      gsap.fromTo(
        [doctorRef.current, mobileDoctorRef.current],
        {
          ...
          <div className="py-10 flex flex-col items-center text-center px-4">
            <div className="overflow-hidden">
              <h1
                ...
                data-aos-duration="1000"
                data-aos-easing="ease-out-cubic"
                className="w-full sm:text-[16px] text-sm font-black leading-relaxed text-gray-800"
              >
                WORLD CLASS MEDICAL CARE
              </h1>
            </div>
            ...
            <div className="overflow-hidden mt-6">
              <p
                ...
                data-aos-duration="1000"
                data-aos-easing="ease-out-cubic"
                className="mx-auto max-w-[75%] text-[16px] font-bold text-black"
              >
                Expert Cancer Care, Cardiology, Neurology &amp; 25+ Specialties
              </p>
            </div>
